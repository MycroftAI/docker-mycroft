...
EXPOSE 8181
RUN ["/bin/bash", "python", "/mycroft/ai/mycroft/messagebus/service/main.py > /mycroft/ai/scripts/logs/mycroft-skills.log &"]
RUN ["/bin/bash", "python", "/mycroft/ai/mycroft/client/speech/main.py > /mycroft/ai/scripts/logs/mycroft-skills.log &"]
RUN ["/bin/bash", "python", "/mycroft/ai/mycroft/skills/main.py > /mycroft/ai/scripts/logs/mycroft-skills.log &"]
RUN ["/bin/bash", "python", "/mycroft/ai/mycroft/audio/main.py > /mycroft/ai/scripts/logs/mycroft-skills.log &"]
